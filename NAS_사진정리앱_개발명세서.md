...
- 상단바: 라이브러리 셀렉터(📚가족/👤내 사진/(관리자)구성원/📦기기 백업 — 기기
  백업엔 신규 유입 +N 뱃지) · 주 메뉴 3영역(사진/앨범/정리) · 검색창
  (기기 백업·타인 열람 중엔 숨김) · 빌드 배지 · 작업 기록 · 로그아웃.
  앨범 영역에선 셀렉터가 "내 사진" 고정 표시(개인 전용이라 죽은 컨트롤 방지).
- 모바일: 하단 탭 바(3영역), 시스템 뒤로가기는 히스토리 깊이 미러링(useBackTrap).
